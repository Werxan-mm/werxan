		...
		<div class="container">
			...
			<div class="col-md-9">
				<div class="choose wow fadeInDown">
					...
					<p>Here you can find the latest dresses!</p>
				</div>
				<div style="height: 20px"></div>
				<div class="news_banner wow zoomIn"></div>
			</div>
		</div>
	</section>
	...
	<div class="news_section">
		<div class="container">
			<div class="news_wrapper">
				<div class="col-md-4">
					<div class="news_goods wow zoomIn">
						<img src="images/fashion-Men-wool-coat-Korean-style-winter_84429.jpg">
						<p>New product<span>7 May 2017</span></p>
					</div>
				</div>
				<div class="col-md-8">
				<div class="info">
					<h1>New in Men Collection</h1>
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia aut, saepe nam illo odit aliquid! Ea, enim, quasi. Reprehenderit molestias doloremque et illo ratione dolorem eos adipisci eum, omnis quo.lorem
					Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsum ex excepturi magni earum repellendus ratione optio voluptatibus vero vel dolorem! Incidunt ut sapiente nostrum ipsa, alias ullam perferendis aspernatur sequi!</p>
						<button class="floatright">Read More</button>
				</div>
				</div>
			</div>
			<div class="news_wrapper">
				<div class="col-md-8">
				<div class="info">
					<h1>New in Women Collection</h1>
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia aut, saepe nam illo odit aliquid! Ea, enim, quasi. Reprehenderit molestias doloremque et illo ratione dolorem eos adipisci eum, omnis quo.lorem
					Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsum ex excepturi magni earum repellendus ratione optio voluptatibus vero vel dolorem! Incidunt ut sapiente nostrum ipsa, alias ullam perferendis aspernatur sequi!</p>
					<button class="floatleft">Read More</button>
				</div>
