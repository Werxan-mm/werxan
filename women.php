...
<html>
<head>
	<title>Online Shopping/Women</title>
...
<body>
		...
		<div class="container">
			...
			<div class="col-md-9">
				<div class="choose wow fadeInDown">
					<h1>Women Choice</h1>
					<p>Here you can find the best dresses for women ever!</p>
				</div>
				<div style="height: 20px"></div>
				<div class="women_banner wow zoomIn"></div>
			</div>
		</div>
	</section>
	<div class="choose">
	...
	<div class="women_product">
		<div class="container-fluid">
			<div class="col-md-3">
				<div class="women_goods wow zoomIn">
